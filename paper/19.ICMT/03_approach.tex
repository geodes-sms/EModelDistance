...
For similar rules represent ghost movements.\es{should we show one rule in Henshin?}
...
In this work, we want to detect the sequence of rule applications starting from the initial model leading to the target model in \Fig{fig:example}.
