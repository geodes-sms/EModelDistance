...
public interface PetrinetPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>P2t</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>T2p</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int TRANSITION__T2P = 1;
	...
	/**
	 * Returns the meta object for the reference list '{@link Petrinet.Place#getP2t <em>P2t</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>P2t</em>'.
	 * @see Petrinet.Place#getP2t()
	 * @see #getPlace()
	 * @generated
	 */
	EReference getPlace_P2t();
	...
	/**
	 * Returns the meta object for the reference list '{@link Petrinet.Transition#getT2p <em>T2p</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>T2p</em>'.
	 * @see Petrinet.Transition#getT2p()
	 * @see #getTransition()
	 * @generated
	 */
	EReference getTransition_T2p();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>P2t</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference PLACE__P2T = eINSTANCE.getPlace_P2t();
		...
		/**
		 * The meta object literal for the '<em><b>T2p</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference TRANSITION__T2P = eINSTANCE.getTransition_T2p();
