...
public class PlaceItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addP2tPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the P2t feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addP2tPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_p2t_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_p2t_feature", "_UI_Place_type"),
				 PetrinetPackage.Literals.PLACE__P2T,
				 true,
				 false,
				 true,
				 null,
