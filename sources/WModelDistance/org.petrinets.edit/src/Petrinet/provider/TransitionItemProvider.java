...
public class TransitionItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addT2pPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the T2p feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addT2pPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_t2p_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_t2p_feature", "_UI_Transition_type"),
				 PetrinetPackage.Literals.TRANSITION__T2P,
				 true,
				 false,
				 true,
				 null,
